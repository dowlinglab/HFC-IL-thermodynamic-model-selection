...
configuration = {
    ...
    "components": {
        "bmimSCN": {"type": Component,
                    "enth_mol_ig_comp": RPP,
                    "entr_mol_ig_comp": RPP,
                    "valid_phase_types": PT.liquidPhase,
                    "phase_equilibrium_form": {("Vap", "Liq"): log_fugacity},
                    "parameter_data": {
                        "mw": (197.0E-3, pyunits.kg/pyunits.mol),  # [1]
                        "pressure_crit": (2.5E06, pyunits.Pa),  # [1]
                        "temperature_crit": (981, pyunits.K),  # [1]
                        "omega": 0.600,  # [1]
    ...
    "parameter_data": {"PR_kappa": {("bmimSCN", "bmimSCN"): 0.000,
                                    ("bmimSCN", "R32"): -0.01408977877696036,
                                    ("R32", "R32"): 0.000,
                                    ("R32", "bmimSCN"): -0.018059739008510666}}}
