...
from idaes.generic_models.properties.core.eos.ceosk import Cubic, CubicType
...
configuration = {
    ...
    # "parameter_data": {"PR_kappa": {("bmimPF6", "bmimPF6"): {"A": (0.0), "B": (0.0, 1/pyunits.K)},
    #                                 ("bmimPF6", "R32"): {'A': (0.0), 'B': (0.0, 1/pyunits.K)},
    #                                 ("R32", "R32"): {'A': (0.0), 'B': (0.0, 1/pyunits.K)},
    #                                 ("R32", "bmimPF6"):{'A': (0.0), 'B': (0.0, 1/pyunits.K)}}}}
    "parameter_data": {"PR_kappa_A": {("bmimPF6", "bmimPF6"): 0.0,
                                    ("bmimPF6", "R32"): -0.3292,
                                    ("R32", "R32"): 0.0,
                                    ("R32", "bmimPF6"):  -0.91345},
                      "PR_kappa_B": {("bmimPF6", "bmimPF6"): 0.0,
                                    ("bmimPF6", "R32"): -0.001232,
                                    ("R32", "R32"): 0.0,
                                    ("R32", "bmimPF6"): 0.002427},
                      "PR_kappa_C": {("bmimPF6", "bmimPF6"): 0.0,
                                    ("bmimPF6", "R32"): -0.001232,
                                    ("R32", "R32"): 0.0,
                                    ("R32", "bmimPF6"): 0.002427}}}
