...
def binary_params_peng(file, configuration, comp_1, comp_2, x_comp_1, x_comp_2,
    ...
    def PR_model(data):
        ...
        # m.fs.properties.PR_kappa_C[comp_2, comp_1].setlb(-0.01)
        # m.fs.properties.PR_kappa_C[comp_2, comp_1].setub(0.01)
        #
        # m.fs.properties.PR_kappa_C[comp_1, comp_2].setlb(-0.01)
        # m.fs.properties.PR_kappa_C[comp_1, comp_2].setub(0.01)
