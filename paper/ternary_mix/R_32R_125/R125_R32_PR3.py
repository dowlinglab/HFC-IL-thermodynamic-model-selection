...
from idaes.generic_models.properties.core.eos.ceos_k_cuad import Cubic, CubicType
...
configuration = {
    ...
    "components": {
        "R32": {"type": Component,
                  ...
                  "parameter_data": {
                      ...
                      "pressure_crit": (58.3e5, pyunits.Pa),  # [1]
                      ...
                      "pressure_sat_comp_coeff": {"A": (4.6932, None),  # [2]
                                                  "B": (1033.304797, pyunits.K),
                                                  "C": (4.3423e-05, pyunits.K)}}},
        ...
        "R125": {"type": Component,
                  ...
                  "parameter_data": {
                      ...
                      "pressure_crit": (35.9e5, pyunits.Pa),  # [1]
                      ...
                      "entr_mol_form_vap_comp_ref": (
                          -269, pyunits.J/pyunits.mol/pyunits.K),  # [2]
                      "pressure_sat_comp_coeff": {"A": (4.55069, None),  # [2]
                                                  "B": (1017.2097, pyunits.K),
                                                  "C": (8.3042e-05, pyunits.K)}}}},
    ...
    "parameter_data": {"PR_kappa_A": {("R125", "R125"): 0.000,
                                    ("R125", "R32"): 0.0,
                                    ("R32", "R32"): 0.000,
                                    ("R32", "R125"): 0.0},
                     "PR_kappa_B": {("R125", "R125"): 0.000,
                                    ("R125", "R32"): 0.0,
                                    ("R32", "R32"): 0.000,
                                    ("R32", "R125"): 0.0},
                     "PR_kappa_C": {("R125", "R125"): 0.000,
                                    ("R125", "R32"): 0.0,
                                    ("R32", "R32"): 0.000,
                                    ("R32", "R125"): 0.0}}}
