...
from idaes.models.properties.modular_properties.phase_equil.bubble_dew_tray import \
        LogBubbleDew
...
#                     "pressure_sat_comp": NIST,
                    ...
                    "parameter_data": {
                        ...
                        "entr_mol_form_vap_comp_ref": (
                            137.5, pyunits.J/pyunits.mol/pyunits.K),  # [2]
#                         "pressure_sat_comp_coeff": {"A": (1e-8, None),  # [2]
#                                                     "B": (0, pyunits.K),
#                                                     "C": (0, pyunits.K)}}},
                                                    }},
    ...
    # "state_definition": FcpTP,
    # "state_bounds": {"flow_mol_phase_comp": (1e-8, 100, 1000, pyunits.mol/pyunits.s),
    ...
    "state_bounds": {"flow_mol": (1e-8, 100, 10000, pyunits.mol/pyunits.s),
                     "temperature": (10, 300, 800, pyunits.K),
                     "pressure": (5e-4, 1e5, 1e9, pyunits.Pa)},
    "pressure_ref": (101325, pyunits.Pa),
    "temperature_ref": (298.15, pyunits.K),
