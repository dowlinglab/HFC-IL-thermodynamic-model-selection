...
def plot_sens_analysis(data,m,HFC,IL,kappa21,kappa12,T_label):   
    x1,P1= calc_outlet_xP(data,m, HFC, IL, kappa21[0],kappa12[0])
    plt.plot(x1,P1,"b+",label="K21= "+str(kappa21[0])+ "K12= "+ str(kappa12[0]))
    x2,P2= calc_outlet_xP(data,m, HFC, IL, kappa21[0],kappa12[1])
    plt.plot(x2,P2,"g+",label="K21= "+str(kappa21[0])+ "K12= "+ str(kappa12[1]))
    x3,P3= calc_outlet_xP(data,m, HFC, IL,kappa21[0],kappa12[2])
    plt.plot(x3,P3,"m+",label="K21= "+str(kappa21[0])+ "K12= "+ str(kappa12[2]))
    x4,P4= calc_outlet_xP(data,m, HFC, IL,kappa21[0],kappa12[3])
    plt.plot(x4,P4,"c+",label="K21= "+str(kappa21[0])+ "K12= "+ str(kappa12[3]))
    x5,P5= calc_outlet_xP(data,m, HFC, IL,kappa21[1],kappa12[0])
    plt.plot(x5,P5,"b*",label="K21= "+str(kappa21[1])+ "K12= "+ str(kappa12[0]))
    x6,P6= calc_outlet_xP(data,m, HFC, IL,kappa21[1],kappa12[1])
    plt.plot(x6,P6,"g*-",label="K21= "+str(kappa21[1])+ "K12= "+ str(kappa12[1]))
    x7,P7= calc_outlet_xP(data,m, HFC, IL,kappa21[1],kappa12[2])
    plt.plot(x7,P7,"m*",label="K21= "+str(kappa21[1])+ "K12= "+ str(kappa12[2]))
    x8,P8= calc_outlet_xP(data,m, HFC, IL,kappa21[1],kappa12[3])
    plt.plot(x8,P8,"c*",label="K21= "+str(kappa21[1])+ "K12= "+ str(kappa12[3]))
    x9,P9= calc_outlet_xP(data,m, HFC, IL,kappa21[2],kappa12[0])
    plt.plot(x9,P9,"b^",label="K21= "+str(kappa21[2])+ "K12= "+ str(kappa12[0]))
    x10,P10= calc_outlet_xP(data,m, HFC, IL,kappa21[2],kappa12[1])
    plt.plot(x10,P10,"g^",label="K21= "+str(kappa21[2])+ "K12= "+ str(kappa12[1]))
    x11,P11= calc_outlet_xP(data,m, HFC, IL,kappa21[2],kappa12[2])
    plt.plot(x11,P11,"m^",label="K21= "+str(kappa21[2])+ "K12= "+ str(kappa12[2]))
    x12,P12= calc_outlet_xP(data,m, HFC, IL,kappa21[2],kappa12[3])
    plt.plot(x12,P12,"c^",label="K21= "+str(kappa21[2])+ "K12= "+ str(kappa12[3]))
    x13,P13= calc_outlet_xP(data,m, HFC, IL,kappa21[3],kappa12[0])
    plt.plot(x13,P13,"b>",label="K21= "+str(kappa21[3])+ "K12= "+ str(kappa12[0]))
    x14,P14= calc_outlet_xP(data,m, HFC, IL,kappa21[3],kappa12[1])
    plt.plot(x14,P14,"g>",label="K21= "+str(kappa21[3])+ "K12= "+ str(kappa12[1]))
    x15,P15= calc_outlet_xP(data,m, HFC, IL,kappa21[3],kappa12[2])
    plt.plot(x15,P15,"m>",label="K21= "+str(kappa21[3])+ "K12= "+ str(kappa12[2]))
    x16,P16= calc_outlet_xP(data,m, HFC, IL,kappa21[3],kappa12[3])
