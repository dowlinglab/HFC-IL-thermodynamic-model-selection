...
def polynomial(file, configuration, comp_1, comp_2, x_comp_1, x_comp_2,
    ...
    """
    Estimates kappa parameters for SRK equation.
    Args:
    ...
    def SRK_model(data):
        ...
        m.fs.properties.SRK_kappa_A[comp_2, comp_2].fix(0)
        m.fs.properties.SRK_kappa_A[comp_2, comp_1].fix(init_kappa_2_1A)
        m.fs.properties.SRK_kappa_A[comp_1, comp_1].fix(0)
        m.fs.properties.SRK_kappa_A[comp_1, comp_2].fix(init_kappa_1_2A)
        m.fs.properties.SRK_kappa_B[comp_2, comp_2].fix(0)
        m.fs.properties.SRK_kappa_B[comp_2, comp_1].fix(init_kappa_2_1B)
        m.fs.properties.SRK_kappa_B[comp_1, comp_1].fix(0)
        m.fs.properties.SRK_kappa_B[comp_1, comp_2].fix(init_kappa_1_2B)
        m.fs.properties.SRK_kappa_C[comp_2, comp_2].fix(0)
        m.fs.properties.SRK_kappa_C[comp_2, comp_1].fix(init_kappa_2_1C)
        m.fs.properties.SRK_kappa_C[comp_1, comp_1].fix(0)
        m.fs.properties.SRK_kappa_C[comp_1, comp_2].fix(init_kappa_1_2C)
        m.fs.properties.SRK_kappa_D[comp_2, comp_2].fix(0)
        m.fs.properties.SRK_kappa_D[comp_2, comp_1].fix(init_kappa_2_1D)
        m.fs.properties.SRK_kappa_D[comp_1, comp_1].fix(0)
        m.fs.properties.SRK_kappa_D[comp_1, comp_2].fix(init_kappa_1_2D)
...
#         m.fs.state_block.initialize(outlvl=idaeslog.CRITICAL)
        ...
        m.fs.properties.SRK_kappa_A[comp_2, comp_1].setlb(-20)
        m.fs.properties.SRK_kappa_A[comp_2, comp_1].setub(20)

        m.fs.properties.SRK_kappa_A[comp_1, comp_2].setlb(-20)
        m.fs.properties.SRK_kappa_A[comp_1, comp_2].setub(20)

        m.fs.properties.SRK_kappa_B[comp_2, comp_1].setlb(-20)
        m.fs.properties.SRK_kappa_B[comp_2, comp_1].setub(20)

        m.fs.properties.SRK_kappa_B[comp_1, comp_2].setlb(-20)
        m.fs.properties.SRK_kappa_B[comp_1, comp_2].setub(20)

        m.fs.properties.SRK_kappa_C[comp_2, comp_1].setlb(-20)
        m.fs.properties.SRK_kappa_C[comp_2, comp_1].setub(20)

        m.fs.properties.SRK_kappa_C[comp_1, comp_2].setlb(-20)
        m.fs.properties.SRK_kappa_C[comp_1, comp_2].setub(20)
        
        m.fs.properties.SRK_kappa_D[comp_2, comp_1].setlb(-20)
        m.fs.properties.SRK_kappa_D[comp_2, comp_1].setub(20)

        m.fs.properties.SRK_kappa_D[comp_1, comp_2].setlb(-20)
        m.fs.properties.SRK_kappa_D[comp_1, comp_2].setub(20)
    ...
    variable_name = ["fs.properties.SRK_kappa_A['" + comp_2 + "','" + comp_1 + "']",
                     "fs.properties.SRK_kappa_A['" + comp_1 + "','" + comp_2 + "']",
                     "fs.properties.SRK_kappa_B['" + comp_2 + "','" + comp_1 + "']",
                     "fs.properties.SRK_kappa_B['" + comp_1 + "','" + comp_2 + "']",
                     "fs.properties.SRK_kappa_C['" + comp_2 + "','" + comp_1 + "']",
                     "fs.properties.SRK_kappa_C['" + comp_1 + "','" + comp_2 + "']",
                     "fs.properties.SRK_kappa_D['" + comp_2 + "','" + comp_1 + "']",
                     "fs.properties.SRK_kappa_D['" + comp_1 + "','" + comp_2 + "']"]


    solver_opts_dict = {'output_file':filename}
    
    pest = parmest.Estimator(SRK_model, data, variable_name, SSE, tee=False, solver_options=solver_opts_dict)
...
def linear(file, configuration, comp_1, comp_2, x_comp_1, x_comp_2,
    ...
    def SRK_model(data):
        ...
        m.fs.properties.SRK_kappa_B[comp_1, comp_2].fix(init_kappa_1_2B)
        m.fs.properties.SRK_kappa_C[comp_2, comp_2].fix(0)
        m.fs.properties.SRK_kappa_C[comp_2, comp_1].fix(0)
        m.fs.properties.SRK_kappa_C[comp_1, comp_1].fix(0)
        m.fs.properties.SRK_kappa_C[comp_1, comp_2].fix(0)
        # Initialize the flash unit
#         m.fs.state_block.initialize(outlvl=idaeslog.CRITICAL)
        m.fs.state_block.initialize(outlvl=50)
        ...
        # Set bounds on variables to be estimated
        m.fs.properties.SRK_kappa_A[comp_2, comp_1].setlb(-5)
        m.fs.properties.SRK_kappa_A[comp_2, comp_1].setub(5)

        m.fs.properties.SRK_kappa_A[comp_1, comp_2].setlb(-5)
        m.fs.properties.SRK_kappa_A[comp_1, comp_2].setub(5)

        m.fs.properties.SRK_kappa_B[comp_2, comp_1].setlb(-5)
        m.fs.properties.SRK_kappa_B[comp_2, comp_1].setub(5)

        m.fs.properties.SRK_kappa_B[comp_1, comp_2].setlb(-5)
        m.fs.properties.SRK_kappa_B[comp_1, comp_2].setub(5)
    ...
    if optional_params == 'Four':
        ...
        variable_name = ["fs.properties.SRK_kappa_A['" + comp_1 + "','" + comp_2 + "']",
                         "fs.properties.SRK_kappa_A['" + comp_2 + "','" + comp_1 + "']",
                         "fs.properties.SRK_kappa_B['" + comp_1 + "','" + comp_2 + "']",
                         "fs.properties.SRK_kappa_B['" + comp_2 + "','" + comp_1 + "']"]
...
def constant(file, configuration, comp_1, comp_2, x_comp_1, x_comp_2,
    ...
    def SRK_model(data):
        ...
        m.fs.properties.SRK_kappa_A[comp_2, comp_2].fix(0)
        m.fs.properties.SRK_kappa_A[comp_2, comp_1].fix(init_kappa_A_2_1)
        m.fs.properties.SRK_kappa_A[comp_1, comp_1].fix(0)
        m.fs.properties.SRK_kappa_A[comp_1, comp_2].fix(init_kappa_A_1_2)
        m.fs.properties.SRK_kappa_B[comp_2, comp_2].fix(0)
        m.fs.properties.SRK_kappa_B[comp_2, comp_1].fix(0)
        m.fs.properties.SRK_kappa_B[comp_1, comp_1].fix(0)
        m.fs.properties.SRK_kappa_B[comp_1, comp_2].fix(0)
        m.fs.properties.SRK_kappa_C[comp_2, comp_2].fix(0)
        m.fs.properties.SRK_kappa_C[comp_2, comp_1].fix(0)
        m.fs.properties.SRK_kappa_C[comp_1, comp_1].fix(0)
        m.fs.properties.SRK_kappa_C[comp_1, comp_2].fix(0)
...
def constant_CPSA(file, configuration, comp_1, comp_2, x_comp_1, x_comp_2,
    ...
    variable_name = ["fs.properties.SKRK_kappa_A['" + comp_2 + "','" + comp_1 + "']",
                 "fs.properties.SR_kappa_A['" + comp_1 + "','" + comp_2 + "']",
                 "fs.properties.emimTf2N.pressure_crit",
                 "fs.properties.emimTf2N.temperature_crit",
                 "fs.properties.emimTf2N.omega"]

    pest = parmest.Estimator(SRK_model, data, variable_name, SSE, tee=True)
