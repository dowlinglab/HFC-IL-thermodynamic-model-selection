...
def cuadratic(file, configuration, comp_1, comp_2, x_comp_1, x_comp_2,
    ...
    def VDW_model(data):
        ...
        m.fs.properties.VDW_kappa_A[comp_2, comp_2].fix(0)
        m.fs.properties.VDW_kappa_A[comp_2, comp_1].fix(init_kappa_2_1A)
        m.fs.properties.VDW_kappa_A[comp_1, comp_1].fix(0)
        m.fs.properties.VDW_kappa_A[comp_1, comp_2].fix(init_kappa_1_2A)
        m.fs.properties.VDW_kappa_B[comp_2, comp_2].fix(0)
        m.fs.properties.VDW_kappa_B[comp_2, comp_1].fix(init_kappa_2_1B)
        m.fs.properties.VDW_kappa_B[comp_1, comp_1].fix(0)
        m.fs.properties.VDW_kappa_B[comp_1, comp_2].fix(init_kappa_1_2B)
        m.fs.properties.VDW_kappa_C[comp_2, comp_2].fix(0)
        m.fs.properties.VDW_kappa_C[comp_2, comp_1].fix(init_kappa_2_1C)
        m.fs.properties.VDW_kappa_C[comp_1, comp_1].fix(0)
        m.fs.properties.VDW_kappa_C[comp_1, comp_2].fix(init_kappa_1_2C)
        ...
        m.fs.properties.VDW_kappa_A[comp_2, comp_1].setlb(-20)
        m.fs.properties.VDW_kappa_A[comp_2, comp_1].setub(20)

        m.fs.properties.VDW_kappa_A[comp_1, comp_2].setlb(-20)
        m.fs.properties.VDW_kappa_A[comp_1, comp_2].setub(20)

        m.fs.properties.VDW_kappa_B[comp_2, comp_1].setlb(-20)
        m.fs.properties.VDW_kappa_B[comp_2, comp_1].setub(20)

        m.fs.properties.VDW_kappa_B[comp_1, comp_2].setlb(-20)
        m.fs.properties.VDW_kappa_B[comp_1, comp_2].setub(20)

        m.fs.properties.VDW_kappa_C[comp_2, comp_1].setlb(-20)
        m.fs.properties.VDW_kappa_C[comp_2, comp_1].setub(20)

        m.fs.properties.VDW_kappa_C[comp_1, comp_2].setlb(-20)
        m.fs.properties.VDW_kappa_C[comp_1, comp_2].setub(20)
    ...
    variable_name = ["fs.properties.VDW_kappa_A['" + comp_2 + "','" + comp_1 + "']",
                     "fs.properties.VDW_kappa_A['" + comp_1 + "','" + comp_2 + "']",
                     "fs.properties.VDW_kappa_B['" + comp_2 + "','" + comp_1 + "']",
                     "fs.properties.VDW_kappa_B['" + comp_1 + "','" + comp_2 + "']",
                     "fs.properties.VDW_kappa_C['" + comp_2 + "','" + comp_1 + "']",
                     "fs.properties.VDW_kappa_C['" + comp_1 + "','" + comp_2 + "']"]


    pest = parmest.Estimator(VDW_model, data, variable_name, SSE, tee=True)
...
def linear(file, configuration, comp_1, comp_2, x_comp_1, x_comp_2,
    ...
    def PR_model(data):
        ...
        m.fs.properties.VDW_kappa_B[comp_1, comp_2].fix(init_kappa_1_2B)
        m.fs.properties.VDW_kappa_C[comp_2, comp_2].fix(0)
        m.fs.properties.VDW_kappa_C[comp_2, comp_1].fix(0)
        m.fs.properties.VDW_kappa_C[comp_1, comp_1].fix(0)
        m.fs.properties.VDW_kappa_C[comp_1, comp_2].fix(0)
        # Initialize the flash unit
        m.fs.state_block.initialize(outlvl=idaeslog.CRITICAL)
        ...
        # Set bounds on variables to be estimated
        m.fs.properties.VDW_kappa_A[comp_2, comp_1].setlb(-5)
        m.fs.properties.VDW_kappa_A[comp_2, comp_1].setub(5)

        m.fs.properties.VDW_kappa_A[comp_1, comp_2].setlb(-5)
        m.fs.properties.VDW_kappa_A[comp_1, comp_2].setub(5)

        m.fs.properties.VDW_kappa_B[comp_2, comp_1].setlb(-5)
        m.fs.properties.VDW_kappa_B[comp_2, comp_1].setub(5)

        m.fs.properties.VDW_kappa_B[comp_1, comp_2].setlb(-5)
        m.fs.properties.VDW_kappa_B[comp_1, comp_2].setub(5)
    ...
    if optional_params == 'Four':
        ...
        variable_name = ["fs.properties.VDW_kappa_A['" + comp_1 + "','" + comp_2 + "']",
                         "fs.properties.VDW_kappa_A['" + comp_2 + "','" + comp_1 + "']",
                         "fs.properties.VDW_kappa_B['" + comp_1 + "','" + comp_2 + "']",
                         "fs.properties.VDW_kappa_B['" + comp_2 + "','" + comp_1 + "']"]
...
def constant(file, configuration, comp_1, comp_2, x_comp_1, x_comp_2,
    ...
    def VDW_model(data):
        ...
        m.fs.properties.VDW_kappa_A[comp_2, comp_2].fix(0)
        m.fs.properties.VDW_kappa_A[comp_2, comp_1].fix(init_kappa_A_2_1)
        m.fs.properties.VDW_kappa_A[comp_1, comp_1].fix(0)
        m.fs.properties.VDW_kappa_A[comp_1, comp_2].fix(init_kappa_A_1_2)
        m.fs.properties.VDW_kappa_B[comp_2, comp_2].fix(0)
        m.fs.properties.VDW_kappa_B[comp_2, comp_1].fix(0)
        m.fs.properties.VDW_kappa_B[comp_1, comp_1].fix(0)
        m.fs.properties.VDW_kappa_B[comp_1, comp_2].fix(0)
        m.fs.properties.VDW_kappa_C[comp_2, comp_2].fix(0)
        m.fs.properties.VDW_kappa_C[comp_2, comp_1].fix(0)
        m.fs.properties.VDW_kappa_C[comp_1, comp_1].fix(0)
        m.fs.properties.VDW_kappa_C[comp_1, comp_2].fix(0)
