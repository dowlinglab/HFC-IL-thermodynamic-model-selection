...
lhs = pd.read_csv('Data/Fits/LHS_Fits/SRK_polyTdep_scLHS_227.csv')
...
for i in range(len(lhs)):
    ...
    try:
        ...
        eps = 0.1, scaling_fac = 1e-7, filename='Data/Fits/LHS_Fits/Ipopt_Output/SRK_polyTdep/SRK_polyTdep_LHS_ipopt_params_fromsc227_'+str(i)+'.txt')
...
lhs.to_csv('Data/Fits/LHS_Fits/SRK_polyTdep_LHS_fromsc227.csv',sep=',')