...
Parameter T dependence: Linear in [imimTF2N,R125] directions
...
# #Try initialized from PR noTdep Opt1 (127) using initial scaled parameters for Params 3, LHS for params 1-2 **this works
# lhs = pd.read_csv('Data/Fits/LHS_Fits/PR_3params_Opt2_127_scLHS.csv')

#Try initialized from PR noTdep Opt2 (5) using initial scaled parameters for Params 3, LHS for params 1-2 **this works
lhs = pd.read_csv('Data/Fits/LHS_Fits/PR_3params_Opt2_5_scLHS.csv')
...
for i in range(len(lhs)):
    ...
    try:
        ...
        init_kappa_2_1B = lhs['sc_param3'][i], init_kappa_1_2B = 0.0, 
        eps = 0.1, scaling_fac = 1e-9 , optional_params = 'Opt2', filename='Data/Fits/LHS_Fits/Ipopt_Output/PR_3params_Opt2/PR_3params_Opt2_LHS_ipopt_params_from5scLHS'+str(i)+'.txt')
...
lhs.to_csv('Data/Fits/LHS_Fits/PR_3params_Opt2_LHS_from5scLHS.csv',sep=',')