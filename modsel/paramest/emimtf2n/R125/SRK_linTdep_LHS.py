...
for i in range(len(lhs)):
    ...
    try:
        ...
        eps = 0.1, scaling_fac = 1e-9, filename='Data/Fits/LHS_Fits/Ipopt_Output/SRK_linTdep/SRK_linTdep_LHS_ipopt_params'+str(i)+'.txt')
...
lhs.to_csv('Data/Fits/LHS_Fits/SRK_linTdep_LHS.csv',sep=',')