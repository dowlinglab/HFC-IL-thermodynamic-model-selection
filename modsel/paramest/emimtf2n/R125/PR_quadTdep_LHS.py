...
for i in range(len(lhs)):
    ...
    print('sc_param1:',lhs['sc_param1'][i])
    print('sc_param2:',lhs['sc_param2'][i])
    print('sc_param3:',lhs['sc_param3'][i])
    print('sc_param4:',lhs['sc_param4'][i])
    print('sc_param5:',lhs['sc_param5'][i])
    print('sc_param6:',lhs['sc_param6'][i])
    ...
    try:
        ...
        eps = 0.1, scaling_fac = 1e-7 , filename='Data/Fits/LHS_Fits/Ipopt_Output/PR_quadTdep/PR_quadTdep_LHS_ipopt_params'+str(i)+'.txt')
...
lhs.to_csv('Data/Fits/LHS_Fits/PR_quadTdep_LHS.csv',sep=',')