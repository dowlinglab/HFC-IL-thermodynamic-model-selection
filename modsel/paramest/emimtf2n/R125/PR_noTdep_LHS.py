...
# lhs = pd.read_csv('Data/Fits/LHS_Fits/PR_noTdep_scLHS_Opt1_102.csv')

#Try initialized from PR 1 parameter Opt1=2 using initial scaled parameters for Params 1, LHS for params 2
lhs = pd.read_csv('Data/Fits/LHS_Fits/PR_noTdep_scLHS_Opt2_120.csv')

# lhs = pd.read_csv('../../LHS_250x8.txt') #Note 250 samples does not work, but 1000 samples does
...
for i in range(len(lhs)):
    ...
    try:
        ...
        eps = 0.1, scaling_fac = 1e-9 , read=False, filename='Data/Fits/LHS_Fits/Ipopt_Output/PR_noTdep/PR_noTdep_LHS_ipopt_params_fromsc_Opt2_120_'+str(i)+'.txt')
...
lhs.to_csv('Data/Fits/LHS_Fits/PR_noTdep_LHS_fromsc_Opt2_120.csv',sep=',')