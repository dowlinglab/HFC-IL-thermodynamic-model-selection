...
for i in range(len(lhs)):
    ...
    try:
        ...
        init_kappa_2_1B = 0.0, init_kappa_1_2B = lhs['sc_param4'][i], 
        eps = 0.1, scaling_fac = 1e-9 , optional_params = 'Opt1', filename='Data/Fits/LHS_Fits/Ipopt_Output/PR_3params_Opt1/PR_3params_Opt1_LHS_ipopt_params'+str(i)+'.txt')
...
lhs['PR_kappa_B[R125,emimTf2N]']=result[:,2]
lhs['SSR']=result[:,3]

lhs.to_csv('Data/Fits/LHS_Fits/PR_3params_Opt1_LHS.csv',sep=',')