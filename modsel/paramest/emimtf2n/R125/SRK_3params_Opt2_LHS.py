...
#Try initialized from PR noTdep using initial scaled parameters for Params 1-2, LHS for params 3
lhs = pd.read_csv('Data/Fits/LHS_Fits/SRK_3params_Opt2_50_scLHS.csv')
...
for i in range(len(lhs)):
    ...
    try:
        ...
        eps = 0.1, scaling_fac = 1e-9 , optional_params = 'Opt2', filename='Data/Fits/LHS_Fits/Ipopt_Output/SRK_3param_Opt2/SRK_3params_Opt2_LHS_ipopt_params_fromsc_'+str(i)+'.txt')
...
lhs.to_csv('Data/Fits/LHS_Fits/SRK_3params_Opt2_LHS_fromsc.csv',sep=',')