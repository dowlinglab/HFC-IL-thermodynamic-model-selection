...
for i in range(len(lhs)):
    ...
    try:
        ...
        eps = 0.1, scaling_fac = 1e-9 , read=False, optional_params='Opt1', filename='Ipopt_Output/SRK_1param_Opt1/SRK_1param_Opt1_LHS_ipopt_params_final_'+str(i)+'.txt', )
...
#Save result
lhs['SRK_kappa_A[R125,emimTf2N]']=result[:,0]
lhs['SSR']=result[:,1]

lhs.to_csv('LHS_Output/SRK_1param_Opt1_LHS_final.csv',sep=',')