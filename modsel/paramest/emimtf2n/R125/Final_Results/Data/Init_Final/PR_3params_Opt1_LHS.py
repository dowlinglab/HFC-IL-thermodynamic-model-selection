...
for i in range(len(lhs)):
    ...
    try:
        ...
        eps = 0.1, scaling_fac = 1e-9 , optional_params = 'Opt1', filename='Ipopt_Output/PR_3params_Opt1/PR_3params_Opt1_LHS_ipopt_params_final_'+str(i)+'.txt')
...
lhs.to_csv('LHS_Output/PR_3params_Opt1_LHS_final.csv',sep=',')