...
for i in range(len(lhs)):
    ...
    try:
        ...
        eps = 0.1, scaling_fac = 1e-7 , filename='Ipopt_Output/PR_quadTdep/PR_quadTdep_LHS_ipopt_params_final_'+str(i)+'.txt')
...
lhs.to_csv('LHS_Output/PR_quadTdep_LHS_final.csv',sep=',')