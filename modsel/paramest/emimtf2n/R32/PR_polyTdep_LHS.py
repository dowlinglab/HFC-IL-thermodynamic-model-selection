...
# #Bound - scaling
# lhs['sc_param1'] = ((lhs['Param1']-lhs['Param1'].min())/(lhs['Param1'].max()-lhs['Param1'].min()))*40+(-20)
# lhs['sc_param2'] = ((lhs['Param2']-lhs['Param2'].min())/(lhs['Param2'].max()-lhs['Param2'].min()))*40+(-20)
# lhs['sc_param3'] = ((lhs['Param3']-lhs['Param3'].min())/(lhs['Param3'].max()-lhs['Param3'].min()))*40+(-20)
# lhs['sc_param4'] = ((lhs['Param4']-lhs['Param4'].min())/(lhs['Param4'].max()-lhs['Param4'].min()))*40+(-20)
# lhs['sc_param5'] = ((lhs['Param5']-lhs['Param5'].min())/(lhs['Param5'].max()-lhs['Param5'].min()))*40+(-20)
# lhs['sc_param6'] = ((lhs['Param6']-lhs['Param6'].min())/(lhs['Param6'].max()-lhs['Param6'].min()))*40+(-20)
# lhs['sc_param7'] = ((lhs['Param7']-lhs['Param7'].min())/(lhs['Param7'].max()-lhs['Param7'].min()))*40+(-20)
# lhs['sc_param8'] = ((lhs['Param8']-lhs['Param8'].min())/(lhs['Param8'].max()-lhs['Param8'].min()))*40+(-20)
...
lhs['PR_kappa_B[emimTf2N,R32]']=result[:,2]
lhs['PR_kappa_B[R32,emimTf2N]']=result[:,3]
lhs['PR_kappa_C[emimTf2N,R32]']=result[:,4]
lhs['PR_kappa_C[R32,emimTf2N]']=result[:,5]
lhs['PR_kappa_D[emimTf2N,R32]']=result[:,6]
lhs['PR_kappa_D[R32,emimTf2N]']=result[:,7]
lhs['SSR']=result[:,8]
