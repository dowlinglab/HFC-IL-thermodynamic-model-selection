...
from idaes.generic_models.properties.core.eos.ceos_k_tempdep_vdw import Cubic, CubicType
...
configuration = {
    ...
    "parameter_data": {"VDW_kappa_A": {("emimTf2N", "emimTf2N"): 0.000,
                                    ("emimTf2N", "R32"): -0.200,
                                    ("R32", "R32"): 0.000,
                                    ("R32", "emimTf2N"): -0.05619},
                     "VDW_kappa_B": {("emimTf2N", "emimTf2N"): 0.000,
                                    ("emimTf2N", "R32"): 0.0,
                                    ("R32", "R32"): 0.000,
                                    ("R32", "emimTf2N"): 0.0},
                     "VDW_kappa_C": {("emimTf2N", "emimTf2N"): 0.000,
                                    ("emimTf2N", "R32"): 0.0,
                                    ("R32", "R32"): 0.000,
                                    ("R32", "emimTf2N"): 0.0}}}