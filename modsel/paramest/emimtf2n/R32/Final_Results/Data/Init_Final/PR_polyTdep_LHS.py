...
# lhs = pd.read_csv('PR_polyTdep_fromquad_init.csv')
...
for i in range(len(lhs)):
    ...
    try:
        ...
        eps = 0.1, scaling_fac = 1e-7, filename='Ipopt_Output/PR_polyTdep/PR_polyTdep_LHS_ipopt_params_extbnd_final_'+str(i)+'.txt')
...
lhs.to_csv('LHS_Output/PR_polyTdep_LHS_extbnd_final.csv',sep=',')