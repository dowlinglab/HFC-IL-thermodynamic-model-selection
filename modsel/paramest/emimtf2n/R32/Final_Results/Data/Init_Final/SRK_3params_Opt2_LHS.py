...
for i in range(len(lhs)):
    ...
    try:
        ...
        eps = 0.1, scaling_fac = 1e-9 , optional_params = 'Opt2', filename='Ipopt_Output/SRK_3params_Opt2/SRK_3params_Opt2_LHS_ipopt_params_final_'+str(i)+'.txt')
...
lhs.to_csv('LHS_Output/SRK_3params_Opt2_LHS_final.csv',sep=',')