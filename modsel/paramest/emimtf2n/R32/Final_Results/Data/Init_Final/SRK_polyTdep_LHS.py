...
# lhs = pd.read_csv('SRK_polyTdep_fromquad_init.csv')
...
for i in range(len(lhs)):
    ...
    try:
        ...
        eps = 0.1, scaling_fac = 1e-7, filename='Ipopt_Output/SRK_polyTdep/SRK_polyTdep_LHS_ipopt_params_extbnd_final_'+str(i)+'.txt')
...
lhs.to_csv('LHS_Output/SRK_polyTdep_LHS_extbnd_final.csv',sep=',')