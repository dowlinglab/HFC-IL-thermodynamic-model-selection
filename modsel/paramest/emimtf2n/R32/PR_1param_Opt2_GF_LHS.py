...
for i in range(len(lhs)):
    ...
    try:
        ...
        init_kappa_A_2_1 = lhs['sc_param1'][i], init_kappa_A_1_2 = -0.05, 
        eps = 0.1, scaling_fac = 1e-9 , read=False, optional_params='Opt2', filename='Data/Fits/LHS_Fits/Ipopt_Output/PR_1param_Opt2_GF/PR_1param_Opt2_GF_LHS_ipopt_params'+str(i)+'.txt')
...
lhs.to_csv('Data/Fits/LHS_Fits/PR_1param_Opt2_GF_LHS.csv',sep=',')