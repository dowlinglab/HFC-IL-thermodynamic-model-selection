...
lhs = pd.read_csv('Data/Fits/LHS_Fits/SRK_polyTdep_scLHS_fromPRsc_1000.csv')
...
for i in range(len(lhs)):
    ...
    try:
        ...
        eps = 0.1, scaling_fac = 1e-7, filename='Data/Fits/LHS_Fits/Ipopt_Output/SRK_polyTdep/SRK_polyTdep_LHS_ipopt_params_fromPRsc_1000_'+str(i)+'.txt')
...
lhs['SRK_kappa_D[emimTf2N,R32]']=result[:,6]
lhs['SRK_kappa_D[R32,emimTf2N]']=result[:,7]
lhs['SSR']=result[:,8]

lhs.to_csv('Data/Fits/LHS_Fits/SRK_polyTdep_LHS_fromPRsc_1000.csv',sep=',')