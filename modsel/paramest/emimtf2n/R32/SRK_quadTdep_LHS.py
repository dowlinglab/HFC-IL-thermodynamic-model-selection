...
for i in range(len(lhs)):
    ...
    try:
        ...
        eps = 0.1, scaling_fac = 1e-7, filename='Data/Fits/LHS_Fits/Ipopt_Output/SRK_quadTdep/SRK_quadTdep_LHS_ipopt_params_fromsc'+str(i)+'.txt')
...
lhs.to_csv('Data/Fits/LHS_Fits/SRK_quadTdep_LHS_fromsc.csv',sep=',')