...
for i in range(len(lhs)):
    ...
    try:
        ...
        eps = 0.1, scaling_fac = 1e-9 , read=False, filename='Data/Fits/LHS_Fits/Ipopt_Output/SRK_noTdep/SRK_noTdep_LHS_ipopt_params'+str(i)+'.txt')
...
lhs.to_csv('Data/Fits/LHS_Fits/SRK_noTdep_LHS.csv',sep=',')