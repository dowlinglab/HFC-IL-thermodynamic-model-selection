...
from idaes.generic_models.properties.core.eos.ceos_k_tempdep_polynomial import Cubic, CubicType
...
configuration = {
    ...
    "parameter_data": {"PR_kappa_A": {("bmimpf6", "bmimpf6"): 0.000,
                                    ("bmimpf6", "R125"): -0.200,
                                    ("R125", "R125"): 0.000,
                                    ("R125", "bmimpf6"): -0.05619},
                     "PR_kappa_B": {("bmimpf6", "bmimpf6"): 0.000,
                                    ("bmimpf6", "R125"): 0.0,
                                    ("R125", "R125"): 0.000,
                                    ("R125", "bmimpf6"): 0.0},
                     "PR_kappa_C": {("bmimpf6", "bmimpf6"): 0.000,
                                    ("bmimpf6", "R125"): 0.0,
                                    ("R125", "R125"): 0.000,
                                    ("R125", "bmimpf6"): 0.0},
                      "PR_kappa_D": {("bmimpf6", "bmimpf6"): 0.000,
                                    ("bmimpf6", "R125"): 0.0,
                                    ("R125", "R125"): 0.000,
                                    ("R125", "bmimpf6"): 0.0}}}