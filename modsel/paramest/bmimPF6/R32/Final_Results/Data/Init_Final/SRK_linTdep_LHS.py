...
for i in range(len(lhs)):
    ...
    try:
        ...
        eps = 0.1, scaling_fac = 1e-9, filename='Ipopt_Output/SRK_linTdep/SRK_linTdep_LHS_ipopt_params_final_'+str(i)+'.txt')
...
lhs.to_csv('LHS_Output/SRK_linTdep_LHS_final.csv',sep=',')