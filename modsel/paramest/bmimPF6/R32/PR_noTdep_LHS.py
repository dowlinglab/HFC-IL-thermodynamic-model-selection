...
lhs = pd.read_csv('Data/Fits/LHS_Fits/PR_noTdep_from206.csv')

# #Try initialized from PR 1 parameter Opt2 using initial scaled parameters for Params 1, LHS for params 2 
# lhs = pd.read_csv('Data/Fits/LHS_Fits/PR_noTdep_scLHS_Opt2_206.csv')
...
for i in range(len(lhs)):
    ...
    try:
        ...
        eps = 0.1, scaling_fac = 1e-9 , read=False, filename='Data/Fits/LHS_Fits/Ipopt_Output/PR_noTdep/PR_noTdep_LHS_ipopt_params_from206_'+str(i)+'.txt')
...
lhs.to_csv('Data/Fits/LHS_Fits/PR_noTdep_LHS_from206.csv',sep=',')