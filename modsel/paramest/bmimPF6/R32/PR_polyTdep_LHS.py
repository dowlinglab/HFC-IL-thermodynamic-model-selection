...
lhs = pd.read_csv('Data/Fits/LHS_Fits/PR_polyTdep_from227_1000.csv')
...
for i in range(len(lhs)):
    ...
    try:
        ...
        eps = 0.1, scaling_fac = 1e-7, filename='Data/Fits/LHS_Fits/Ipopt_Output/PR_polyTdep/PR_polyTdep_LHS_ipopt_params_from227_1000_'+str(i)+'.txt')
...
lhs['PR_kappa_C[bmimpf6,R32]']=result[:,4]
lhs['PR_kappa_C[R32,bmimpf6]']=result[:,5]
lhs['PR_kappa_D[bmimpf6,R32]']=result[:,6]
lhs['PR_kappa_D[R32,bmimpf6]']=result[:,7]
lhs['SSR']=result[:,8]

lhs.to_csv('Data/Fits/LHS_Fits/PR_polyTdep_LHS_from227_1000.csv',sep=',')