...
for i in range(len(lhs)):
    ...
    try:
        ...
        eps = 0.1, scaling_fac = 1e-9 , optional_params = 'Opt1', filename='Data/Fits/LHS_Fits/Ipopt_Output/SRK_3params_Opt1/SRK_3params_Opt1_LHS_ipopt_params'+str(i)+'.txt')
...
lhs['SRK_kappa_B[R32,bmimpf6]']=result[:,2]
lhs['SSR']=result[:,3]
