...
for i in range(len(lhs)):
    ...
    try:
        ...
        eps = 0.1, scaling_fac = 1e-9 , read=False, optional_params='Opt1', filename='Data/Fits/LHS_Fits/Ipopt_Output/PR_1param_Opt1/PR_1param_Opt1_LHS_ipopt_params_1000_'+str(i)+'.txt')
...
#Save result
lhs['PR_kappa_A[R32,bmimpf6]']=result[:,0]
lhs['SSR']=result[:,1]

lhs.to_csv('Data/Fits/LHS_Fits/PR_1parameter_Opt1_LHS_1000.csv',sep=',')