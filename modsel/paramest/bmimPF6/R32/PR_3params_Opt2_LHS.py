...
Parameter T dependence: Linear in [bmimpf6,R32] directions
...
# #Try initialized from PR noTdep using initial scaled parameters for Params 1-2, LHS for params 3 **this works
lhs = pd.read_csv('Data/Fits/LHS_Fits/PR_3params_Opt2_from105.csv')
...
for i in range(len(lhs)):
    ...
    try:
        ...
        eps = 0.1, scaling_fac = 1e-9 , optional_params = 'Opt2', filename='Data/Fits/LHS_Fits/Ipopt_Output/PR_3params_Opt2/PR_3params_Opt2_LHS_ipopt_params_from105_'+str(i)+'.txt')
...
lhs.to_csv('Data/Fits/LHS_Fits/PR_3params_Opt2_LHS_from105.csv',sep=',')