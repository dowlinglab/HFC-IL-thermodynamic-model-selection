...
for i in range(len(lhs)):
    ...
    try:
        ...
        eps = 0.1, scaling_fac = 1e-7 , filename='Data/Fits/LHS_Fits/Ipopt_Output/PR_quadTdep/PR_quadTdep_LHS_ext_ipopt_params'+str(i)+'.txt')
...
lhs.to_csv('Data/Fits/LHS_Fits/PR_quadTdep_LHS_ext.csv',sep=',')